...
<body>
                ...
                <div class="item-grid">
                    ...
                    foreach ($items as $item) {
                        echo '<div class="item-option" onclick="selectItem(this, \'' . $item['value'] . '\', ' . $item['price'] . ')">
                            ...
                            <input type="hidden" name="item" id="item-' . $item['value'] . '" value="">
                        </div>';
                    }
                    ?>
                </div>
    ...
    <script>
        ...
        function selectItem(element, itemName, price) {
            ...
            // Perbarui nilai input tersembunyi untuk item yang dipilih
            document.getElementById('item-' + itemName).value = itemName;  // Set nilai input dengan item yang dipilih
