...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!isset($_SESSION['user_id'])) {
        ...
        if ($stmt->execute()) {
            $message = "Halo, saya ingin melakukan convert Mata Uang:\n\n" .
                "- No. Telepon: $phone\n" .
                "- Kategori: $item\n" .
    ...
    <div class="container">
        ...
        <div class="icon-info card">
            <div style="display: flex; align-items: center; gap: 10px;">
                <img src="../images/convert.jpg" alt="edit photo" class="icon-logo">
                <h2>Jasa Edit convert</h2>
            </div>
            <div class="separator"></div>
            <p>Pesan Jasa Edit convert Dengan Harga Affordable.<br>
                1. Pilih Kategori Editing convert Yang Anda Inginkan.<br>
                ...
                5. Anda Akan Mendapatkan convert Yang Sudah Diedit Dengan Kualitas Terbaik.</p>
        </div>
        ...
        <form id="edit-photo-form" method="POST" class="form-section">
            ...
            <div class="card">
                ...
                <input type="text"name="note" placeholder="Masukkan catatan khusus untuk edit convert (opsional)"></input>
            </div>

            <!-- Submit -->
            <div class="card">
                <button type="submit">Konfirmasi Edit convert →</button>
            </div>
        </form>
    </div>
    <script>
