        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p>QuicsX hadir untuk membantu kegiatan digital dengan sat set dan aman setiap saat.</p>
    ...
    <section class="services">
        <div class="container">
            ...
            <div class="services-grid">
                <a href="/e-wallet-top-up.html" class="service-card">
        ...
        <div class="container">
            <div class="solution-content">
                ...
                <div class="solution-steps">
                    ...
                    <a href="#" class="btn" style="margin-top: 1.5rem;">Mulai Sekarang</a>
                </div>
            </div>
        </div>
    </section>
